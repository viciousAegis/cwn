...
class GraphDataset:
    ...
    def __str__(self):
        return 'GraphDataset: {}'.format(self.name) + '\n' + \
            'Number of graphs: {}'.format(len(self.graphs)) + '\n' + \
            'Number of classes: {}'.format(len(torch.unique(self.Y))) + '\n' + \
            'Number of training samples: {}'.format(len(self.train_index)) + '\n' + \
            'Number of validation samples: {}'.format(len(self.val_index)) + '\n' + \
            'Number of testing samples: {}'.format(len(self.test_index)) + '\n'
